...
import { DecodeRequestOTPToken, RequestForgotPassword, VerifyOTP, VerifyOTPToken } from '../controllers/auth/forgot-password.controller';
import { RequestChangeEmailController, VerifyChangeEmailToken } from '../controllers/auth/change-email.controller';
...
router.post("/request/change/email",Authenticate,RequestChangeEmailController)
