...
import CreateResource, {  DeleteResource, EditResource, GetFeedResources, GetResource, UpvoteIndividualLink,EditResourceFetchResource, GetResourceMetaDetails } from '../controllers/resource/resource.controller';
